...
public class ConsoleCanvas extends JPanel implements ActionListener, KeyListener {
	...
	private ca.retrylife.hsa2.GraphicsConsole container;
	...
	public ConsoleCanvas(int width, int height, int fontSize, String title, ca.retrylife.hsa2.GraphicsConsole console)
	{
